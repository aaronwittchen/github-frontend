        ...
        <div class="flex-1">
          ...
          <div class="mt-2 space-y-1 text-sm text-gray-400">
            ...
            <div v-if="user?.blog" class="flex items-center">
              ...
              <a :href="user.blog" target="_blank" class="hover:underline">{{ user.blog }}</a>
            </div>
      ...
      <div v-if="topRepository" class="mt-6 border-t border-gray-700 pt-4">
        ...
        <div class="bg-gray-800 rounded-lg p-4 hover:bg-gray-750 transition-colors">
          <div class="flex justify-between items-start">
            <div>
              <a :href="topRepository.htmlUrl" target="_blank" class="text-lg font-semibold hover:underline">
                {{ topRepository.name }}
              </a>
              <p class="mt-1 text-sm text-gray-400">{{ topRepository.description }}</p>
              <div class="flex items-center mt-2 text-xs text-gray-400 space-x-4">
                <span class="flex items-center">
                  <span class="w-3 h-3 rounded-full mr-1" :style="{ backgroundColor: getLanguageColor(topRepository.language) }"></span>
            ...
            <a :href="`${topRepository.htmlUrl}/stargazers`" target="_blank" class="text-yellow-400 hover:text-yellow-300">
